        ...
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="flex-shrink-0 flex items-center">
            <Link href="/" className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-gray-900 dark:text-white">DroneCrops</span>
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link href="/services" className="text-gray-700 dark:text-gray-300 hover:text-green-600 dark:hover:text-green-400 transition-colors">
              Services
            </Link>
